...
async function CountingSort(delay = 250) {
  ...
  for (var i = 0; i < blocks.length; i += 1) {
    ...
    if (value >= 1 && value <= 5) {
      ...
      array_ele.style.transform = `translate(${block1 * 56}px)`;
      container.appendChild(array_ele);
      block1++;
    }
    ...
    if (value >= 6 && value <= 10) {
      ...
      array_ele.style.transform = `translate(${block2 * 56}px)`;
      container.appendChild(array_ele);
      block2++;
    }
    ...
    if (value >= 11 && value <= 15) {
      ...
      array_ele.style.transform = `translate(${block3 * 56}px)`;
      container.appendChild(array_ele);
      block3++;
    }
    ...
    if (value >= 16 && value <= 20) {
      ...
      array_ele.style.transform = `translate(${block4 * 56}px)`;
      container.appendChild(array_ele);
      block4++;
    }
